#!/usr/bin/env node
/**
 * @lua-ai-global/governance CLI — Interactive project setup
 *
 * Usage: npx @lua-ai-global/governance init
 *
...
function banner() {
  print("");
  print(`${BOLD}${MAGENTA}  @lua-ai-global/governance${RESET}`);
...
function generateConfigFile(config: InitConfig): string {
  ...
  const importLine = `import { ${imports.join(", ")} } from '@lua-ai-global/governance';`;
...
`;
  ...
  return `/**
 * @lua-ai-global/governance configuration
 * Generated by: npx @lua-ai-global/governance init
 *
...
async function main() {
  ...
  if (command !== "init") {
    print(`${BOLD}@lua-ai-global/governance${RESET} — Runtime governance for TypeScript AI agents\n`);
    print(`${BOLD}Usage:${RESET}`);
    print(`  npx @lua-ai-global/governance init    Set up governance in your project`);
    print(`  npx @lua-ai-global/governance --help  Show this help message\n`);
